...
class PoolManager:
    ...
    def _choose_nodes_to_prune(
        ...
        for node_metadata in prioritized_killable_nodes:
            ...
            #  4) Killing the node's tasks would take over the maximum number of tasks we are willing to kill.
            #     But agent.task_count may be outdated date (case 2), and pods may be terminated unintentionally.
