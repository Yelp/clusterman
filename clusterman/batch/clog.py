...
log_stream_format = clog_namespace.get_string("log_stream_format", default=DETAILED_FORMAT)
log_stream_level = clog_namespace.get_string("log_stream_level", default="INFO")
enable_uwsgi_mule_offload = clog_namespace.get_bool("enable_uwsgi_mule_offload", default=False)
