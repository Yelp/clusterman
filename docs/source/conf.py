#!/usr/bin/env python3
#
# clusterman documentation build configuration file, created by
...
project = 'clusterman'
copyright = '2017, distsys-processing'
...
htmlhelp_basename = 'clustermandoc'
...
man_pages = [
    (master_doc, 'clusterman', 'clusterman Documentation',
     [author], 1)
]
