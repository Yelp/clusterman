...
| metric name                                        | timestamp  | value                           |
+----------------------------------------------------+------------+---------------------------------+
| spot_prices|AZ=us-west-2a,instance_type=c3.8xlarge | 1502405756 | 1.30                            |
+----------------------------------------------------+------------+---------------------------------+
| spot_prices|AZ=us-west-2c,instance_type=c3.8xlarge | 1502405756 | 5.27                            |
+----------------------------------------------------+------------+---------------------------------+
| capacity|cluster=norcal-prod,role=seagull          | 1502409314 | | {"c3.8xlarge,us-west-2a": 4,  |
|                                                    |            | | "c3.8xlarge,us-west-2c": 20}  |
+----------------------------------------------------+------------+---------------------------------+
