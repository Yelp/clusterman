...
class NamespaceAccessor:
    def read_bool(
        self, config_key: str, default: Optional[bool] = None, namespace: str = DEFAULT_NAMESPACE
    ) -> bool: ...
    def read_float(
        self, config_key: str, default: Optional[float] = None, namespace: str = DEFAULT_NAMESPACE
    ) -> float: ...
    def read_list(
        self, config_key: str, default: Optional[List] = None, namespace: str = DEFAULT_NAMESPACE
    ) -> List: ...
    def read_int(self, config_key: str, default: Optional[int] = None, namespace: str = DEFAULT_NAMESPACE) -> int: ...
    def read_string(
        self, config_key: str, default: Optional[str] = None, namespace: str = DEFAULT_NAMESPACE
    ) -> str: ...
