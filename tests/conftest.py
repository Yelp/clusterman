...
def clusterman_pool_config():
    config = {
        ...
        'scaling_limits': {
            ...
            'max_capacity_mem': float('inf'),
            'max_capacity_disk': float('inf'),
            'max_capacity_gpus': float('inf'),
            'max_cpus_to_add': 200,
            'max_mem_to_add': 200000,
            'max_mem_to_add': 200000,
            'max_disk_to_add': 200000,
            'max_gpus_to_add': 200000,
            'max_cpus_to_remove': 10,
            'max_mem_to_remove': 10000,
            'max_mem_to_remove': 10000,
            'max_disk_to_remove': 10000,
            'max_gpus_to_remove': 10000,
        },
        'sensu_config': [
            {
                'team': 'other-team',
