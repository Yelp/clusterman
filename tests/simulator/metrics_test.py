...
@pytest.fixture
def mock_ts_1():
    return {'metric_1': [(arrow.get(1), 1.0), (arrow.get(2), 2.0), (arrow.get(3), 3.0)]}


@pytest.fixture
def mock_ts_2():
    return {'metric_2': [(arrow.get(1), 4.0), (arrow.get(2), 5.0), (arrow.get(4), 6.0)]}
...
class TestMetricsWriter:
    ...
    def test_overwrite_existing_metrics(self, mock_reader, mock_confirm, mock_ts_1, mock_ts_2, mock_open):
        ...
        to_write = {'metric_1': [(arrow.get(42), 9), (arrow.get(4245), 77)]}
